...
public class JambeWalk : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Rleg.localRotation = Quaternion.Slerp(Quaternion.Euler(-45, 0, 0), Quaternion.Euler(45, 0, 0), leglerp);
            Lleg.localRotation = Quaternion.Slerp(Quaternion.Euler(-45, 0, 0), Quaternion.Euler(45, 0, 0), Mathf.Abs(leglerp - 1));
